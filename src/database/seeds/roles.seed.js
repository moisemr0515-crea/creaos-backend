...
const PERMISOS_SISTEMA = [
  ...
  { module: 'products', action: 'read', slug: PERMISSIONS.PRODUCTS_READ, description: 'Ver catálogo de productos' },
  { module: 'products', action: 'create', slug: PERMISSIONS.PRODUCTS_CREATE, description: 'Crear productos' },
  { module: 'products', action: 'update', slug: PERMISSIONS.PRODUCTS_UPDATE, description: 'Editar productos' },
  { module: 'products', action: 'delete', slug: PERMISSIONS.PRODUCTS_DELETE, description: 'Desactivar productos' },
  { module: 'policies', action: 'read', slug: PERMISSIONS.POLICIES_READ, description: 'Ver políticas del negocio' },
  { module: 'policies', action: 'create', slug: PERMISSIONS.POLICIES_CREATE, description: 'Crear políticas' },
  { module: 'policies', action: 'update', slug: PERMISSIONS.POLICIES_UPDATE, description: 'Editar políticas' },
  { module: 'policies', action: 'delete', slug: PERMISSIONS.POLICIES_DELETE, description: 'Archivar políticas' },
  { module: 'faqs', action: 'read', slug: PERMISSIONS.FAQS_READ, description: 'Ver preguntas frecuentes' },
  { module: 'faqs', action: 'create', slug: PERMISSIONS.FAQS_CREATE, description: 'Crear preguntas frecuentes' },
  { module: 'faqs', action: 'update', slug: PERMISSIONS.FAQS_UPDATE, description: 'Editar preguntas frecuentes' },
  { module: 'faqs', action: 'delete', slug: PERMISSIONS.FAQS_DELETE, description: 'Archivar preguntas frecuentes' },
